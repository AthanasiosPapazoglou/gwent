...
List <UnitCard> nilfggardUnits = [
  ...
  UnitCard(id: 1, cardName: 'Assire var anahi.png', strength: 6, battlerow: brows.ranged, hasEffect: false, effect: beffects.none, isHero: false),
  ...
  UnitCard(id: 16, cardName: 'Morteisen.png', strength: 3, battlerow: brows.melee, hasEffect: false, effect: beffects.none, isHero: true),
  UnitCard(id: 17, cardName: 'Morvan Voorhis.png', strength: 10, battlerow: brows.siege, hasEffect: false, effect: beffects.none, isHero: true),
  ...
  UnitCard(id: 34, cardName: 'Young Emissart 1.png', strength: 5, battlerow: brows.melee, hasEffect: true, effect: beffects.bond, isHero: false),
  UnitCard(id: 35, cardName: 'Young Emissart 2.png', strength: 5, battlerow: brows.melee, hasEffect: true, effect: beffects.bond, isHero: false),
...
List <UnitCard> northernRealmsUnits = [
  ...
  UnitCard(id: 7, cardName: 'Crinfrid Reaves Dragon Hunter 1.png', strength: 5, battlerow: brows.ranged, hasEffect: true, effect: beffects.bond, isHero: false),
  UnitCard(id: 8, cardName: 'Crinfrid Reaves Dragon Hunter 2.png', strength: 5, battlerow: brows.ranged, hasEffect: true, effect: beffects.bond, isHero: false),
  UnitCard(id: 9, cardName: 'Crinfrid Reaves Dragon Hunter 3.png', strength: 5, battlerow: brows.ranged, hasEffect: true, effect: beffects.bond, isHero: false),
  ...
  UnitCard(id: 23, cardName: 'Redenian Foot Soldier 1.png', strength: 1, battlerow: brows.melee, hasEffect: false, effect: beffects.none, isHero: false),
  UnitCard(id: 24, cardName: 'Redenian Foot Soldier 2.png', strength: 1, battlerow: brows.melee, hasEffect: false, effect: beffects.none, isHero: false),
